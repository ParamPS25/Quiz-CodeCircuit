          ...
          <>
            <div className="bg-indigo-700 text-white p-4 sm:p-6 rounded-3xl relative">
              ...
              <div className="flex flex-wrap justify-between items-center mb-3 sm:mb-4 relative z-10">
                <h2 className="text-3xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br
                   from-purple-400 via-pink-500 to-yellow-500 pb-1 sm:pb-2 w-full sm:w-auto">
                   Quizzy Pro
                </h2>
                <span className="text-sm sm:text-lg font-medium mt-2 sm:mt-0">Q : {currentQuestion + 1}/{questions.length}</span>
              </div>
              <div
            ...
            <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
              <div className="flex flex-wrap justify-between items-center">
                <h3 className="text-xl sm:text-3xl font-bold max-w-[70%] break-words">{questions[currentQuestion].questionText}</h3>
                <span className="text-sm sm:text-lg bg-indigo-100 text-indigo-900 px-3 py-1 rounded-full font-semibold shadow-md whitespace-nowrap mt-2 sm:mt-0">
                  ⏱ {timer}s
                </span>
              </div>
